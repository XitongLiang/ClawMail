...
| `/emails/thread/{thread_id}` | GET | 获取线程上下文 | generate_reply |
| `/memories/{account_id}/for-email?sender_email=` | GET | 获取与发件人相关的偏好记忆 | generate_reply |
| `/memories/{account_id}/for-email` | GET | 获取全局偏好记忆 | generate_email, polish_email |
